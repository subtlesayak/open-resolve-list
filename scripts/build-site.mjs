...
export function buildSite(){
 ...
 const data={latestUpdate:{...latestUpdate,addedCount:latestUpdate.added_urls.length},schema_version:1,title:'Subtle Resolve List',tagline:'The open Resolve ecosystem database.',description:'Curated, source-backed DaVinci Resolve and Fusion tools with compatibility evidence, version tracking and clear uncertainty.',catalogue:'https://github.com/subtlesayak/subtle-resolve-list',tasks:TASKS,entries,releases,updates:history.entries,inventoryCount:inventory.folder_count};
