...
export function build() {
  ...
  fs.writeFileSync(path.join(root, 'README.md'), [
    ...
    `A personal, open directory of **DaVinci Resolve plugins, Fusion tools, DCTLs, LUTs, PowerGrades, scripts and templates**: **${entries.length} public GitHub repositories** and **${external.length} external resources**, with original creator links, documented requirements and update references.`, '',
